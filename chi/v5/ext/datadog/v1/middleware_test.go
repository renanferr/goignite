...
func TestChildSpan(t *testing.T) {
	...
	router.Use(chiMiddleware(WithServiceName("foobar")))
...
func TestAnalyticsSettings(t *testing.T) {
	...
	t.Run("global", func(t *testing.T) {
		...
		rate := datadog.AnalyticsRate()
		defer datadog.SetAnalyticsRate(rate)
		datadog.SetAnalyticsRate(0.4)
